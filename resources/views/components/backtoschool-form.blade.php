<h2 class="text-2xl font-semibold text-center text-gray-800 light:text-dark mb-6" id="register-form">
...
<main class="max-w-xl w-full p-6 bg-white rounded-md shadow-md dark:bg-gray-800 dark:text-gray-300">
    ...
    <form method="POST" action="{{ route('tuition.register') }}" class="space-y-4">
        ...
        <div>
            <label for="email" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Your Email
                Address:</label>
        ...
        <div>
            <label for="phone" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Your Phone
                Number:</label>
        ...
        <div>
            <label for="child_name" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Child’s
                Full Name:</label>
        ...
        <div>
            <label for="stage" class="block text-gray-700 dark:text-gray-300 text-sm font-bold mb-2">Key Stage or
                Exam:</label>
