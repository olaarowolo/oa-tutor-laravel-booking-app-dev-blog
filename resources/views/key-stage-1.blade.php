...
@section('content')
    ...
    <section class="px-5 py-5 mx-auto flex flex-wrap items-center justify-center background blog-text" id="ks1">
        <main class="max-w-5xl w-full">
            ...
            <section class="mb-8">
                ...
                <ul class="list-disc pl-6 space-y-2">
                    <li><b>Qualified and Experienced: </b> I hold high academic qualifications, including a BSc, an MSc, and
                        a
                        PhD, with over 7 years of international teaching experience across primary, secondary, and
                        university
                        levels.</li>
                    <li><b>Safe and Trustworthy:</b> I am fully DBS checked, providing you with peace of mind.</li>
                    <li><b>Dedicated Support:</b> I work closely with each student, building their confidence and fostering
                        a
                        genuine love of learning.</li>
                </ul>
            </section>
        </main>
    </section>
