...
@section('og_description', 'Join our focused Easter group tuition for 11+ and GCSE students.')
    ...
    <meta property="og:description" content="Join our Easter group tuition for 11+ and GCSE students. Learn with compassionate, Christian-based values in an inclusive, focused environment." />
...
<section class="container px-5 py-5 mx-auto flex flex-wrap items-center justify-center" id="easter-package">
    <main class="max-w-4xl w-full">
        <section class="mb-8">
            ...
            <p>
                This Easter, OA Tutors is offering focused <strong>Online Group Tuition</strong> for students preparing for
                the <strong>11+ entrance exams</strong> and <strong>GCSEs</strong>. Our sessions are delivered by qualified,
                passionate tutors who teach with excellence, compassion, and a foundation in Christian values—while welcoming
            ...
            <p>
                Our Easter Break package is designed to be affordable and impactful. Please fill out the form below to receive
            ...
            <!-- Enrolment Button -->
            <div class="mb-6">
                <button onclick="showForm()" class="bg-blue-400 hover:bg-blue-500 text-white font-semibold py-2 px-6 rounded-xl shadow-md transition">
                    Start Enrolment
                </button>
            </div>
...
<div id="formModal" class="fixed inset-0 bg-black bg-opacity-80 hidden items-center justify-center z-50">
    <div class="relative w-full h-full p-4 flex items-center justify-center">
        <!-- Close Button -->
        <button onclick="closeForm()" class="absolute top-4 right-6 text-white text-3xl font-bold z-50 hover:text-red-400">&times;</button>

        <!-- Form Iframe -->
        <iframe class="w-full h-full max-w-5xl max-h-[90vh] bg-white rounded-lg shadow-lg"
            src="https://forms.office.com/r/MheUyW7Qvt?embed=true"
