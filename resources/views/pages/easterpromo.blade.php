    ...
    <main class="max-w-5xl w-full">
        ...
        <section class="mb-8">
            ...
            <ul class="list-disc pl-6 space-y-2">
                <li><strong>Comprehensive Coverage:</strong> 10 dynamic sessions covering GL-style English, Maths, and Verbal Reasoning.</li>
                <li><strong>Convenient Learning:</strong> Downloadable PDF lecture notes after every session for easy revision.</li>
                <li><strong>Daily Progress Tracking:</strong> Auto-marked online homework to monitor performance.</li>
                <li><strong>Real Exam Simulation:</strong> A final online mock exam to gauge readiness before the big day.</li>
                <li><strong>Tailored for Year 5:</strong> Suitable for students preparing for Grammar and Independent Schools following the GL Assessment.</li>
            </ul>
        </section>
        ...
        <section class="mb-8">
            ...
            <ul class="list-disc pl-6 space-y-2">
                ...
                <li><strong>Practical Applications:</strong> Relating concepts to real-world scenarios to improve comprehension.</li>
        ...
        <section class="mb-8">
            ...
            <p>The final session includes a realistic mock exam to simulate real exam conditions, helping your child build confidence and improve exam techniques.</p>
        </section>

        <section class="mb-8">
            <h2 class="text-2xl font-bold mb-4">Limited Time Offer – Enroll Now!</h2>
            <p>Don't miss this opportunity to give your child the edge they need to excel. Enroll today and set them on the path to success!</p>
        </section>
    </main>
</section>
