...
class MedwayTestPostSeeder extends Seeder
{
    public function run()
    {
        BlogPost::create([
            ...
            'category' => 'Education',
            'excerpt' => 'Considering a grammar school education in Medway for your child? This comprehensive guide provides key information for the 2025-2026 admissions cycle.',
